...
# == Usage
#  ficonabses_template.rb -u username -p password -d destination -t template_name
# == Author
#   Scott Sproule  --- Ficonab.com (scott.sproule@ficonab.com, scott.sproule@estormtech.com)
# == Example
#  see usage
# == Copyright
